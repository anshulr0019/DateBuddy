      ...
      <div className="relative h-full w-full max-w-[440px] sm:max-w-lg md:max-w-xl flex flex-col justify-between bg-infyn-paper shadow-2xl sm:border-x sm:border-infyn-ink/5 overflow-hidden">
        ...
        <div className="flex-shrink-0 z-20 px-6 pt-[calc(1.25rem+env(safe-area-inset-top,0px))] pb-2">
          <div className="flex items-center gap-3.5">
            ...
            <span className="text-[12px] font-bold tabular-nums text-infyn-ink/45">6 of 7</span>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 z-10 px-6 overflow-y-auto scrollbar-none pb-6">
          <div className="mb-6">
            <h1 className="text-[26px] font-normal text-infyn-ink tracking-tight font-display">Who would you like to meet?</h1>
            <p className="text-[14px] text-infyn-ink/60 mt-1">Set your discovery preferences for age and distance</p>
          </div>

          <div className="space-y-4">
            {/* Age Range Card */}
            <div className="rounded-[20px] border border-infyn-border/80 bg-infyn-surface/80 p-5 shadow-[0_4px_20px_-10px_rgba(32,26,22,0.06)] backdrop-blur-md">
              <div className="flex items-center justify-between mb-4">
                <label className="text-[13px] font-bold text-infyn-ink uppercase tracking-wider">Age Preference</label>
                <span className="text-[15px] font-extrabold text-infyn-rose bg-infyn-rose/10 px-3 py-1 rounded-full">
                  {ageRange[0]} - {ageRange[1]} yrs
                </span>
              </div>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-[12px] font-medium text-infyn-ink/50 mb-1">
            ...
            <div className="rounded-[20px] border border-infyn-border/80 bg-infyn-surface/80 p-5 shadow-[0_4px_20px_-10px_rgba(32,26,22,0.06)] backdrop-blur-md">
              <div className="flex items-center justify-between mb-3">
                <label className="text-[13px] font-bold text-infyn-ink uppercase tracking-wider">Distance Radius</label>
                <span className="text-[15px] font-extrabold text-infyn-rose bg-infyn-rose/10 px-3 py-1 rounded-full">
                  {distance} km
                </span>
              </div>
              <input
                ...
                className="w-full accent-infyn-rose cursor-pointer mt-2"
              />
            </div>

            <p className="text-[12px] text-infyn-ink/45 text-center pt-2">
